...
const AllocationTable = ({ data }) => {
  const columns = React.useMemo(
    () => [
      { Header: "ID", accessor: "allocationId", width: 50 },
      { Header: "Employee Name", accessor: "assigneeName", width: 80 },
      { Header: "Project Name", accessor: "projectName", width: 80 },
      { Header: "Start Date", accessor: "allocationStartDate", width: 80 },
      { Header: "End Date", accessor: "allocationEndDate", width: 80 },
      { Header: "Allocated By", accessor: "allocatorName", width: 80 },
      { Header: "% Allocation", accessor: "percentageAllocation", width: 80 },
      {
        Header: "Active",
        accessor: "isActive",
        width: 80,
