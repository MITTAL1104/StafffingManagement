...
export const fetchAllData = async (entity) => {
  return authorizedRequest("get", `${API_BASE_URL}/${entity}/getAll`);
};

export const fetchAllActiveData = async (entity) => {
  return authorizedRequest("get", `${API_BASE_URL}/${entity}/getAllActive`);
};
...
export const fetchAllAllocationData = async () => {
  return authorizedRequest("get", `${API_BASE_URL}/allocation/getAll`);
};
...
export const fetchAllocationByEmployeeName = async (name) => {
  return authorizedRequest(
    "get",
    `${API_BASE_URL}/allocation/getByEmpName/${name}`
  );
};

export const fetchByAllocationId = async (id) => {
  return authorizedRequest("get", `${API_BASE_URL}/allocation/getById/${id}`);
};
...
export const fetchByProjectId = async (id) => {
  return authorizedRequest(
    "get",
    `${API_BASE_URL}/allocation/getByProjId/${id}`
  );
};
...
export const fetchByNameForUpdate = async (entity, name) => {
  return authorizedRequest(
    "get",
    `${API_BASE_URL}/${entity}/getByName/${name}`
  );
};
...
export const fetchByNameForUpdateAllocation = async (entity, name) => {
  return authorizedRequest(
    "get",
    `${API_BASE_URL}/${entity}/getByEmpName/${name}`
  );
};
...
export const fetchByProjectNameForUpdateAllocation = async (name) => {
  return authorizedRequest(
    "get",
    `${API_BASE_URL}/allocation/updateByProjName/${name}`
  );
};
...
export const fetchIsAdminByEmail = async (email) => {
  return authorizedRequest("get", `${API_BASE_URL}/getIsAdmin/${email}`);
};

export const fetchEmpIdByEmail = async (email) => {
  return authorizedRequest("get", `${API_BASE_URL}/getEmpIdByEmail/${email}`);
};

export const fetchProjIdByEmpId = async (entity, id) => {
  return authorizedRequest(
    "get",
    `${API_BASE_URL}/${entity}/getProjIdByEmpId/${id}`
  );
};
...
export const updateAllocByProjId = async (id, data) => {
  return authorizedRequest(
    "put",
    `${API_BASE_URL}/allocation/updateAllocByProjId/${id}`,
    data
  );
};
...
export const updateDataByName = async (entity, name, data) => {
  return authorizedRequest(
    "put",
    `${API_BASE_URL}/${entity}/updateName/${name}`,
    data
  );
};

export const deleteAllData = async (entity) => {
  return authorizedRequest("delete", `${API_BASE_URL}/${entity}/deleteAll/`);
};
...
export const deleteDataByName = async (entity, name) => {
  return authorizedRequest(
    "delete",
    `${API_BASE_URL}/${entity}/deleteName/${name}`
  );
};
...
export const deleteDataByAllocationID = async (id) => {
  return authorizedRequest(
    "delete",
    `${API_BASE_URL}/allocation/deleteId/${id}`
  );
};
...
export const deleteDataByEmployeeID = async (id) => {
  return authorizedRequest(
    "delete",
    `${API_BASE_URL}/allocation/deleteEmpId/${id}`
  );
};
...
export const deleteDataByProjectID = async (id) => {
  return authorizedRequest(
    "delete",
    `${API_BASE_URL}/allocation/deleteProjId/${id}`
  );
};
